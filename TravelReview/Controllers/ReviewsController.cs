...
namespace TravelReview.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Location,Comment,Published,CategoryID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Location,Comment,Published,CategoryID")] Review review)
        {
            if (ModelState.IsValid)
            {
